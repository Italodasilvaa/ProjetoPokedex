<template>
  <div id="app">
    <div class="column is-half is-offset-one-quarter is-mobile">
      <img src="./assets/poke.png" class="imgLogo" /><br />
      <input type="text" class="input is-hovered is-rounded"   placeholder="Buscar Pokemon"  v-model="busca"
      />
      <button class="button is-info" id="buscaBtn" @click="buscar" >Buscar</button>
